                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Enter Name" value="{{ old('name', $brand->name) }}" required>
                                    @error('name')
                            ...
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control" placeholder="Auto-generated slug" value="{{ old('slug', $brand->slug) }}" readonly>
                                </div>
                            </div>
